...
=======
lockfileVersion: 5.4
>>>>>>> 551a14d (working perfectly, but output is janky with the underline dashes and shit)
>>>>>>> fixed-output-tables
...
packages:
  ...
  /@types/node/14.14.9:
    resolution: {integrity: sha512-JsoLXFppG62tWTklIoO4knA+oDTYsmqWxHRvd4lpmfQRNhX6osheUOWETP2jMoV/2bEHuMra8Pp3Dmo/stBFcw==}
    dev: true
  ...
  /call-bind/1.0.0:
    resolution: {integrity: sha512-AEXsYIyyDY3MCzbwdhzG3Jx1R0J2wetQyUynn6dYHAO+bg8l1k7jwZtRv4ryryFs7EP+NDlikJlVe59jr0cM2w==}
    dependencies:
      function-bind: 1.1.1
      get-intrinsic: 1.0.1
    dev: false
  ...
  /csv-parse/4.14.1:
    resolution: {integrity: sha512-4wmcO7QbWtDAncGFaBwlWFPhEN4Akr64IbM4zvDwEOFekI8blLc04Nw7XjQjtSNy+3AUAgBgtUa9nWo5Cq89Xg==}
    dev: false

  /csv-stringify/5.5.3:
    resolution: {integrity: sha512-JKG8vIHpWPzdilp2SAmvjmAiIhD+XGKGdhZBGi8QIECgJAsFr7k5CmJIW2QkSxBBsctvmojM25s+UINzQ5NLTg==}
    dev: false
  ...
  /dateformat/4.0.0:
    resolution: {integrity: sha512-zpKyDYpeePyYGJp2HhRxLHlA+jZQNjt+MwmcVmLxCIECeC4Ks3TI3yk/CSMKylbnCJ5htonfOugYtRRTpyoHow==}
    dev: false
  ...
  /get-intrinsic/1.0.1:
    resolution: {integrity: sha512-ZnWP+AmS1VUaLgTRy47+zKtjTxz+0xMpx3I52i+aalBK1QP19ggLF3Db89KJX7kjfOfP2eoa01qc++GwPgufPg==}
    dependencies:
      function-bind: 1.1.1
      has: 1.0.3
      has-symbols: 1.0.1
  ...
  /smartwrap/2.0.1:
    resolution: {integrity: sha512-BoOIGADm5Q9OXGVmT899L1fx6dvOYciVUPB9yFlE1XkxRs3/6sqT/HYZoXOxNb4jj2zshtH+jhmGa6wGkNDPgA==}
    engines: {node: '>=6'}
    hasBin: true
    dependencies:
      array.prototype.flat: 1.2.4
  ...
  /stream-transform/2.0.3:
    resolution: {integrity: sha512-HgNXs2rNG9pKC2gK4owtMPMKfto81S/TWZw0Ybsx6Wp23klnN0YctnMXYe0PmzzhB/zIBEB+0Urf+PMorE4d/A==}
    dependencies:
      mixme: 0.4.0
    dev: false
  ...
  /tty-table/4.1.3:
    resolution: {integrity: sha512-Aireaxah5bTJkkJ7b2RI8tMZxogscWP4UCgi5dKuOqL8BWPjnnOebC7F+oFYWTLKUaiJm8h+CvsigBaaCtxqGw==}
    engines: {node: '>=8.0.0'}
    hasBin: true
    dependencies:
      chalk: 3.0.0
